...
- **CoveredLinesCollector**: Collects the number of covered lines for each test (test and production lines).
...
| DataType                 | CoEvolutionTestTypeCollector | DependencyCollector | DirectnessCollector           | IEEETestTypeCollector         | ISTQBTestTypeCollector        | LOCAndMcCabeCollector         | MaximumCallGraphDepthCollector | MutationDataCollector | NamingConventionTestTypeCollector | NumAssertionCollector         | TestCoverageCollector         | CoveredLinesCollector         |
|--------------------------|------------------------------|---------------------|-------------------------------|-------------------------------|-------------------------------|-------------------------------|--------------------------------|-----------------------|-----------------------------------|-------------------------------|-------------------------------|-------------------------------|
...
| Coverage Data (Java)     | -                            | x (method-level)    | -                             | x (class-level, method-level) | x (class-level, method-level) | -                             | -                              | x (method-level)      | x (method-level)                  | -                             | x (class-level, method-level) | x (class-level, method-level) |
| Coverage Data (Python)   | -                            | x (method-level)    | -                             | x (class-level, method-level) | x (class-level, method-level) | -                             | -                              | -                     | x (method-level)                  | -                             | x (class-level, method-level) | x (class-level, method-level) |
